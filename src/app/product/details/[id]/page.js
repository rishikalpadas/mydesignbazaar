        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative bg-gray-50 rounded-lg overflow-hidden border select-none" onContextMenu={(e) => e.preventDefault()}>
              ...
              {product?.isExclusive && (
                <div className="absolute top-4 right-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-1.5 rounded-full text-sm font-bold shadow-lg z-20 flex items-center gap-1.5">
